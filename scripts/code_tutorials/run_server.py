...
# 2. Create NER-tagger.
# tagger_ner = load_flair_ner("ner-fast-with-lowercase")  # or another tagger
...
server = HTTPServer(
    server_address, make_handler(base_url, wiki_version, model, tagger_ner, filter_conf=filter_conf),
)
